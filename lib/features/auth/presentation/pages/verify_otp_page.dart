...
class _VerifyOtpViewState extends State<VerifyOtpView> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _shieldController = AnimationController(vsync: this, duration: const Duration(milliseconds: 1200));
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Verify OTP', style: GoogleFonts.outfit(fontSize: 26, fontWeight: FontWeight.w800, color: Colors.white)),
                      const SizedBox(height: 6),
                      Text(
                        'We\'ve sent a 6-digit code to\n$maskedPhone',
                        style: GoogleFonts.outfit(fontSize: 13, color: Colors.white.withOpacity(0.75), height: 1.5),
                      ),
                    ],
                  ),
                ),
                ...
                Positioned(
                  ...
                  child: RepaintBoundary(
                    child: SizedBox(
                      height: 40,
                      width: double.infinity,
                      child: CustomPaint(painter: HeaderWavePainter(color: Colors.white)),
                    ),
                  ),
                ),
              ],
                  ...
                  return Column(
                    children: [
                      ...
                      Row(
                        ...
                        children: List.generate(6, (index) => _buildOtpBox(index, state.errorMessage != null)),
                      ),
                      ...
                      if (state.errorMessage != null)
                        FadeTransition(
                          ...
                          child: Padding(
                            ...
                            child: Text(state.errorMessage!, style: GoogleFonts.outfit(fontSize: 12, color: const Color(0xFFEF5350))),
                          ),
                        ),
  ...
  Widget _buildSecurityIcon(bool isVerified) {
    return RepaintBoundary(
      child: ScaleTransition(
        scale: CurvedAnimation(parent: _shieldController, curve: Curves.elasticOut),
        child: Container(
          width: 72,
          height: 72,
          ...
          child: AnimatedSwitcher(
            ...
            child: isVerified
                ? const Text('✅', key: ValueKey('verified'), style: TextStyle(fontSize: 36))
                : const Icon(LucideIcons.shieldCheck, key: ValueKey('shield'), color: Color(0xFF6A1B9A), size: 34),
          ),
        ),
      ),
    );
  ...
  Widget _buildOtpBox(int index, bool hasError) {
    ...
    return Container(
      ...
      height: 56,
      decoration: BoxDecoration(
        color: isFilled ? const Color(0xFF6A1B9A).withOpacity(0.08) : const Color(0xFFF8F6FB),
        borderRadius: BorderRadius.circular(14),
        border: Border.all(
          color: isFilled 
              ? const Color(0xFF6A1B9A).withOpacity(0.4) 
              : (hasError ? const Color(0xFFEF5350).withOpacity(0.4) : const Color(0xFF6A1B9A).withOpacity(0.12)),
          width: 2,
        ),
      ),
      child: TextField(
        ...
        style: GoogleFonts.outfit(fontSize: 22, fontWeight: FontWeight.w800, color: const Color(0xFF6A1B9A)),
    ...
    return Row(
      ...
      children: List.generate(6, (i) {
        return AnimatedContainer(
          ...
          height: 3,
          decoration: BoxDecoration(
            color: i < filledCount ? const Color(0xFF6A1B9A) : const Color(0xFFE0E0E0),
      ...
      child: AnimatedContainer(
        ...
        child: state.isLoading
            ...
            : Text(
                ...
                style: GoogleFonts.outfit(fontSize: 15, fontWeight: FontWeight.bold, color: isReady ? Colors.white : const Color(0xFF6A1B9A).withOpacity(0.4)),
              ),
      ),
    );
  }
  ...
  Widget _buildResendSection(BuildContext context, OtpState state) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        Text('Didn\'t receive the code? ', style: GoogleFonts.outfit(fontSize: 13, color: const Color(0xFF757575))),
        state.resendTimer > 0
            ? Text('Resend in ${state.resendTimer}s', style: GoogleFonts.outfit(fontSize: 13, color: const Color(0xFF9E9E9E), fontWeight: FontWeight.w600))
            : GestureDetector(
                onTap: () {
                  for (var c in _controllers) {
                    c.clear();
                ...
                child: Text('Resend OTP', style: GoogleFonts.outfit(fontSize: 13, color: const Color(0xFF6A1B9A), fontWeight: FontWeight.bold)),
              ),
      ],
    );
  }
  ...
  Widget _buildInfoBox() {
    return Container(
      ...
      decoration: BoxDecoration(color: const Color(0xFFF8F6FB), borderRadius: BorderRadius.circular(14)),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          Expanded(
            child: Text(
              ...
              style: GoogleFonts.outfit(fontSize: 12, color: const Color(0xFF757575), height: 1.6),
            ),
          ),
        ],
      ),
  ...
  Widget _buildDemoHint() {
    return Container(
      ...
      child: Text(
        ...
        textAlign: TextAlign.center,
        style: GoogleFonts.outfit(fontSize: 11, color: const Color(0xFFF57F17)),
      ),
    );
  }
}
